...
public class OI {
  ...
  public Button lb3 = new JoystickButton(leftJoystick, 3), xboxStart = new JoystickButton(xbox, 8),
      xboxBack = new JoystickButton(xbox, 7), xboxB = new JoystickButton(xbox, 2), xboxA = new JoystickButton(xbox, 1),
      xboxY = new JoystickButton(xbox, 4), xboxX = new JoystickButton(xbox, 3), xboxLB = new JoystickButton(xbox, 5),
      xboxRB = new JoystickButton(xbox, 6), xboxLJB = new JoystickButton(xbox, 9),
      ...
      // Ex. BGTL = Button Group Top Left. I DID TEST THE BUTTON VALUES SO DO NOT
      // CHANGE NOW!!! >:(
  ...
  public OI() {
    ...
    // XBOX LB IS USED FOR AUTO HATCH PLACEMENT, DO NOT BIND!!!
